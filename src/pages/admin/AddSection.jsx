...
import CustomPaginationActionsTableSection from '../table/CustomPaginationActionsTableSection';
...
function AddSection() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5050/api/section/get-sections ', { // Update the URL as needed
      headers: {
  ...
  return (
    <div>
      <h1 className='text-2xl font-bold p-2 m-3'>Add Section</h1>
      ...
      <div>
        ...
        {
          students?.length>0 ? <CustomPaginationActionsTableSection data={students}/>:"No students registered"
        }
