...
import CustomPaginationActionsTableSession from '../table/CustomPaginationActionsTableSession';
function AddSession() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5050/api/session/get-sessions', { // Update the URL as needed
      headers: {
  ...
  return (
    <div>
      <h1 className='text-2xl font-bold p-2 m-3'>Add Sessiont</h1>
      ...
      <div>
        ...
        {
          students?.length>0 ? <CustomPaginationActionsTableSession data={students}/>:"No students registered"
        }
