...
function AddStudent() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5050/api/students/get-students', { // Update the URL as needed
      headers: {
  ...
  return (
    <div>
      <h1 className='text-2xl font-bold p-2 m-3'>Register Student</h1>
      ...
      <div>
        ...
        {
          students?.length>0 ? <CustomPaginationActionsTable data={students}/>:"No students registered"
        }
